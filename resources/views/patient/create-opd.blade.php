    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg  p-4">
                ...
                <img src="{{\Illuminate\Support\Facades\Storage::url('patient.png')}}" alt="Patient Image"
                    class="m-auto w-24">
                ...
                <form action="{{ route('patient.store-opd') }}" method="POST" class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-3 ">
                        ...
                        <div>
                            ...
                            <input type="text" required name="father_husband_name" id="father_husband_name"
                                class="w-full px-3 py-2 border rounded-md text-gray-700 focus:outline-none focus:border-blue-500"
                        ...
                        <div>
                            ...
                            <input type="text" name="mobile" autocomplete="off"
                                value="{{ old('mobile', '0300-1234567') }}" required id="mobile"
                                class="w-full px-3 py-2 border rounded-md text-gray-700 focus:outline-none focus:border-blue-500"
