                        ...
                        @foreach($data as $key => $value)
                            <tr class="border-black">
                                ...
                                <td class="border-black border px-4 py-2 text-center">
                                    {{ number_format($value['Invoices Entitled'],0) }}

                                </td>
                                <td class="border-black border px-4 py-2 text-center">
                                    {{ number_format($value['Invoices Non Entitled'],0) }}
...
{{--                                <td class="border-black border px-4 py-2 text-center">{{ number_format($value['Invoices'],2) }}</td>--}}
                                ...
                                <td class="border-black border px-4 py-2 text-center">
                                    {{ number_format($value['Chit Entitled'],0) }}
                                </td>
                                <td class="border-black border px-4 py-2 text-center">
                                    {{ number_format($value['Chit Non Entitled'],0) }}
                                </td>
...
{{--                                <td class="border-black border px-4 py-2 text-center">{{ number_format($value['Chits'],2) }}</td>--}}
                                <td class="border-black border px-4 py-2 text-center">
{{--                                    {{ number_format($value['Chits']+$value['Invoices'],2)  }}--}}
                                {{ number_format(($value['Invoices']-$value['Invoices HIF']) + ($value['Chits']-$value['Chits HIF']),2) }}
...
{{--                            <td class="border-black border px-4 py-2 text-center font-bold">{{ number_format($totalChits,2) }}</td>--}}
                            <td class="border-black border px-4 py-2 text-center font-bold">{{ number_format(($totalInvoices-$totalInvoicesHIF) + ($totalChits-$totalChitHIF),2) }}</td>
                        </tr>
