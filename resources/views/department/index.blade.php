<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <a href="{{route('department.create')}}" class="float-right inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent
                    ...
                    <table class="table-auto w-full border-collapse border border-black">
                        ...
                        @foreach($departments as $department)
                            <tr class="border-black">
                                ...
                                <td class="border-black border px-4 py-2 text-center">
                                    <form action="{{ route('department.destroy', $department->id) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
