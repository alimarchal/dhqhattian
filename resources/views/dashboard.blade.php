<x-app-layout>
    ...
    <div class="py-3">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @elseif(Auth::user()->hasRole(['Front Desk/Receptionist','Administrator']))
                        ...
                        <div class="p-5">
                            <div class="grid grid-cols-3 gap-1">
                                ...
                                <div class="col-span-1 flex items-center justify-end">
                                    ...
                                    <img src="{{ Storage::url('images/817729.png') }}" alt="legal case"
                                         class="h-12 w-12">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-5">
                            <div class="grid grid-cols-3 gap-1">
                                ...
                                <div class="col-span-1 flex items-center justify-end">
                                    ...
                                    <img src="{{ Storage::url('issue_new_chit.png') }}" alt="legal case"
                                         class="h-12 w-12">
                                </div>
                            </div>
                        </div>
                ...
                @role('Administrator')
                <h1 class="p-4 bg-white font-extrabold text-center text-2xl shadow-xl rounded-lg my-4">Executive Dashboard Daily Statistics</h1>
                <div class="grid grid-cols-12 gap-6 ">
                    ...
                    <div class="col-span-6 md:col-span-6 lg:col-span-6">
                        <div class="bg-white rounded-lg shadow-lg p-4" id="age_wise_chart">
                        </div>
                    </div>
